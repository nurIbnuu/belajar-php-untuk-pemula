...
function registrasi($data) {
  ...
  // enkripsi password; bisa pakai md5(jangan dipakai lagi) atau password_hash
  // password_hash(password_yang_mau_diacak, mengacak_pakai_algoritma_apa)
  // PASSWORD_DEFAULT adalah algoritma default yang dipilih oleh PHP dan algoritma ini akan terus berubah jika ada cara pengamanan password baru
